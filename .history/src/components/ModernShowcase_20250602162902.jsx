                          ...
                          {(() => {
                            ...
                            return paymentStructure && (
                              <div className="mb-4 p-3 rounded-lg bg-white/5 border border-white/10">
                                <p className="text-white/90 text-xs font-medium mb-1">Payment Structure:</p>
                                <div className="flex justify-between text-xs text-white/70">
                                  <span>Deposit (20%): {paymentStructure.deposit}</span>
                                  <span>After kick-off (80%): {paymentStructure.afterKickoff}</span>
                                </div>
                              </div>
                            );
                          })()}
