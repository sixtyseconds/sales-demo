                  ...
                  >
                      ...
                      <div className="flex items-center gap-2 bg-white/5 rounded-lg p-1 backdrop-blur-xl">
                        {Object.keys(currencyRates).map((currencyOption) => (
                          <button
                            ...
                            className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-xl"
                          >
                            {currencyOption}
                          </button>
                        ))}
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-xl ${billingPeriod === 'monthly' ? 'bg-white/20' : ''}`}
                      >
                        Monthly
                      </button>
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-xl ${billingPeriod === 'annual' ? 'bg-white/20' : ''}`}
                      >
                        Annual
                      </button>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
                      {pricingPlans.map((plan) => (
                        <motion.div
                          ...
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: 0.3 + (pricingPlans.indexOf(plan) * 0.1) }}
                          className="p-6 rounded-xl bg-white/[0.02] border border-white/[0.05] backdrop-blur-xl"
                        >
                          ...
                          <div className="mt-4">
                            {plan.features.map((feature, i) => (
                              <p key={i} className="text-base font-light leading-relaxed">{feature.name}</p>
                            ))}
                          </div>
                          <div className="mt-6">
                          ...
                          <div className="mt-2">
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                handleNavigation('pricing', plan);
                              }}
                              className="px-4 py-2 rounded-lg bg-gradient-to-r from-[#8129D7] to-[#2A5EDB] text-white font-medium shadow-lg shadow-indigo-500/20"
                            >
                              {plan.cta}
                            </button>
                          </div>
